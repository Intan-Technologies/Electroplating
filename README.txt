Intan Electroplating Board Software - Source Code (v1.02)
---------------------------------------------------------

This directory contains the Intan Electroplating Board C++/Qt source code and two supporting files:
...
connecting the Intan Electroplating Board to a computer.  (They are not included in this zip file.)
...
The Intan Electroplating software is free software, and is distributed under the terms of the GNU Lesser
